...
\begin{figure}
\includegraphics[width=0.8\linewidth]{true_vs_estimated_all.png}
\end{figure}
\end{frame}
%------------------------------------------------
\begin{frame}
...
\begin{figure}
\includegraphics[width=0.8\linewidth]{true_vs_estimated_noKF.png}
\end{figure}
\end{frame}
%------------------------------------------------INNOVATION---------------------
\begin{frame}
...
\begin{figure}
\includegraphics[width=0.8\linewidth]{innovation_all.png}
\end{figure}
\end{frame}
%------------------------------------------------
\begin{frame}
...
\begin{figure}
\includegraphics[width=0.8\linewidth]{innovation_noKF.png}
\end{figure}
\end{frame}
%-----------------------------------------------SPECTRAL RADII----------------
\begin{frame}
...
\begin{figure}
\includegraphics[width=0.8\linewidth]{spectral_radii_all.png}
\end{figure}
\end{frame}
%------------------------------------------------
\begin{frame}
...
\begin{figure}
\includegraphics[width=0.8\linewidth]{spectral_radii_all_subplots.png}
\end{figure}
\end{frame}
%------------------------------------------------ESTEIMATION ERROR---------------------
\begin{frame}
...
\begin{figure}
\includegraphics[width=0.8\linewidth]{estimation_error_all.png}
\end{figure}
\end{frame}
...
\begin{figure}
\includegraphics[width=0.8\linewidth]{estimation_error_noKF_sigma_s1.png}
\end{figure}
\end{frame}
%------------------------------------------------
\begin{frame}
...
\begin{figure}
\includegraphics[width=0.8\linewidth]{estimation_error_noKF_sigma_s2.png}
\end{figure}
\end{frame}
%------------------------------------------------
\begin{frame}
...
\begin{figure}
\includegraphics[width=0.8\linewidth]{estimation_error_noKF_sigma_s3.png}
\end{figure}
\end{frame}
%------------------------------------------------
\begin{frame}
...
\begin{figure}
\includegraphics[width=0.8\linewidth]{estimation_error_noKF_sigma_s4.png}
\end{figure}
\end{frame}
%------------------------------------------------
\begin{frame}
...
\begin{figure}
\includegraphics[width=0.8\linewidth]{estimation_error_noKF_sigma_s5.png}
\end{figure}
\end{frame}
%% ------------TABLES------------------------
