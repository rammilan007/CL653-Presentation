...
\begin{figure}
\includegraphics[height=3in,width=5in,angle=0]{true_vs_estimated_all-eps-converted-to.pdf}
\end{figure}
\end{frame}
%------------------------------------------------
\begin{frame}
...
\begin{figure}
\includegraphics[height=3in,width=5in,angle=0]{true_vs_estimated_noKF-eps-converted-to.pdf}
\end{figure}
\end{frame}
%------------------------------------------------INNOVATION---------------------
\begin{frame}
...
\begin{figure}
\includegraphics[height=3in,width=5in,angle=0]{innovation_all-eps-converted-to.pdf}
\end{figure}
\end{frame}
%------------------------------------------------
\begin{frame}
...
\begin{figure}
\includegraphics[height=3in,width=5in,angle=0]{innovation_noKF-eps-converted-to.pdf}
\end{figure}
\end{frame}
%-----------------------------------------------SPECTRAL RADII----------------
\begin{frame}
...
\begin{figure}
\includegraphics[height=3in,width=5in,angle=0]{spectral_radii_all-eps-converted-to.pdf}
\end{figure}
\end{frame}
%------------------------------------------------
\begin{frame}
...
\begin{figure}
\includegraphics[height=3in,width=5in,angle=0]{spectral_radii_all_subplots-eps-converted-to.pdf}
\end{figure}
\end{frame}
%------------------------------------------------ESTEIMATION ERROR---------------------
\begin{frame}
...
\begin{figure}
\includegraphics[width=1.0\linewidth]{estimation_error_all.eps}
\end{figure}
\end{frame}
...
\begin{figure}
\includegraphics[height=3in,width=5in,angle=0]{estimation_error_EKF_sigma_all_states-eps-converted-to.pdf}
\end{figure}
\end{frame}
...
\begin{figure}
\includegraphics[height=3in,width=5in,angle=0]{estimation_error_UKF_sigma_all_states-eps-converted-to.pdf}
\end{figure}
\end{frame}
...
\begin{figure}
\includegraphics[height=3in,width=5in,angle=0]{estimation_error_noKF_sigma_s1-eps-converted-to.pdf}
\end{figure}
\end{frame}
%------------------------------------------------
\begin{frame}
...
\begin{figure}
\includegraphics[height=3in,width=5in,angle=0]{estimation_error_noKF_sigma_s2-eps-converted-to.pdf}
\end{figure}
\end{frame}
%------------------------------------------------
\begin{frame}
...
\begin{figure}
\includegraphics[height=3in,width=5in,angle=0]{estimation_error_noKF_sigma_s3-eps-converted-to.pdf}
\end{figure}
\end{frame}
%------------------------------------------------
\begin{frame}
...
\begin{figure}
\includegraphics[height=3in,width=5in,angle=0]{estimation_error_noKF_sigma_s4-eps-converted-to.pdf}
\end{figure}
\end{frame}
%------------------------------------------------
\begin{frame}
...
\begin{figure}
\includegraphics[height=3in,width=5in,angle=0]{estimation_error_noKF_sigma_s5-eps-converted-to.pdf}
\end{figure}
\end{frame}
%-------------------------------------TABLE OF MEAN AND VARIANCES OF INNOVATION-----
\begin{frame}
\frametitle{Table}
\begin{table}
\begin{tabular}{l l l}
